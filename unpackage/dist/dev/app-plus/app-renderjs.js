      ...
      generateImage(callback) {
        setTimeout(() => {
          ...
          (0, import_html2canvas.default)(dom, {
            ...
            __f__("log", "at pages/viewReport/viewReport.vue:1714", canvas);
            const base64 = canvas.toDataURL("image/jpeg");
            callback && callback(base64);
          }).catch((err) => {
            __f__("log", "at pages/viewReport/viewReport.vue:1718", JSON.stringify(err));
          });
        }, 300);
      },
      updateEcharts(newValue, oldValue, ownerInstance, instance) {
        __f__("log", "at pages/viewReport/viewReport.vue:1724", newValue);
        if (newValue) {
          this.generateImage((base64) => {
            ownerInstance.callMethod("receiveRenderData", { name: newValue, base64 });
          });
