<template>
  <view class="cancel">
    ...
    <view class="project-des"
      >为保证您的账号安全，请您在提交申请注销生效前，需要满足并知晓以下内容：</view
    >
    <view class="project-box">
      <view class="first-text">1.当账号无已付费会员，无财产纠纷</view>
      <view class="second-text"
        >请确保所有会员已经服务完成，账号没有任何投诉、违约情况。</view
      >
    ...
    <view class="check-read" @click="checkFlag = !checkFlag">
      ...
      <div class="check-text">
        我已阅读并同意<text class="btn" @click.stop="goto"
          >《账号注销协议》</text
        >
      </div>
    </view>
