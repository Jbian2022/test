...
var Logger = function() {
  ...
  Logger2.create = function(id) {
    Logger2.instances[id] = new Logger2(id);
  };
...
var DocumentCloner = function() {
  ...
  DocumentCloner2.prototype.toIFrame = function(ownerDocument, windowSize) {
    ...
    var iframeLoad = iframeLoader(iframe).then(function() {
      _this2.scrolledElements.forEach(restoreNodeScroll);
      if (cloneWindow) {
      ...
      var onclone = _this2.options.onclone;
      if (typeof _this2.clonedReferenceElement === "undefined") {
        return Promise.reject("Error finding the " + _this2.referenceElement.nodeName + " in the cloned document");
      }
